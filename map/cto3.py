...
class FeedElement(MapFeedElementInterface):
    ...
    def generate(self, prepare:list|None = None):
        ...
        if not self.element_uri:
            ...
            #self.holding_org
            # TODO Add holding organization data
            ...
            if self.media:
                if self.media.type == 'image':
                    ...
                    # TODO Properly implement typing, license and byline
            ...
            for i in self.license.rdflib():
                ...
                # TODO Add labels in i[1] if present
            
            # Byline
            #self.byline
            # TODO Check if byline data can be serialised
