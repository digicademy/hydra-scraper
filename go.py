...
# Endpoints or beacons
if 'lists' in command.download or 'list_triples' in command.download or 'list_nfdi' in command.download or 'beacon' in command.download:
...
# TODO Hand over and require resource list, allow for list generated by folder

# Individual resource files
if 'resources' in command.download or 'resource_triples' in command.download or 'resource_nfdi' in command.download or 'resource_table' in command.download:

    # Setting to download resource files
    resource_download = False
    if 'resources' in command.download:
        resource_download = True

    # Retrieve resources
    resource = HydraRetrieveResource(report) # TODO
